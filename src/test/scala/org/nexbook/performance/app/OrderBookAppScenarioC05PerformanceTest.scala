...
/**
  ...
  */
class OrderBookAppScenarioC05PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioC05PerformanceTest])
  val scenarioName = "scenario_C_05"
