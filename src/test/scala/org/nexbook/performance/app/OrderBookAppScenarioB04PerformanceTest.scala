...
/**
  ...
  */
class OrderBookAppScenarioB04PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioB04PerformanceTest])
  val scenarioName = "scenario_B_04"
