...
/**
  ...
  */
class OrderBookAppScenarioB01PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioB01PerformanceTest])
  val scenarioName = "scenario_B_01"
