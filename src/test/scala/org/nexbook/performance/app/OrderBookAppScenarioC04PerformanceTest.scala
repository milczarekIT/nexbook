...
/**
  ...
  */
class OrderBookAppScenarioC04PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioC04PerformanceTest])
  val scenarioName = "scenario_C_04"
