...
/**
  ...
  */
class OrderBookAppScenarioB03PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioB03PerformanceTest])
  val scenarioName = "scenario_B_03"
