...
/**
  ...
  */
class OrderBookAppScenarioC02PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioC02PerformanceTest])
  val scenarioName = "scenario_C_02"
