...
/**
  ...
  */
class OrderBookAppScenarioA05PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioA05PerformanceTest])
  val scenarioName = "scenario_A_05"
