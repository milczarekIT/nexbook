...
/**
  ...
  */
class OrderBookAppScenarioB02PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioB02PerformanceTest])
  val scenarioName = "scenario_B_02"
