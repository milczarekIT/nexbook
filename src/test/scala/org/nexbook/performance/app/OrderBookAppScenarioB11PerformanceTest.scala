...
/**
  ...
  */
class OrderBookAppScenarioB11PerformanceTest extends OrderBookAppPerformanceTest {

  val logger = LoggerFactory.getLogger(classOf[OrderBookAppScenarioB11PerformanceTest])
  val scenarioName = "scenario_B_11"
